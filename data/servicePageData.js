// ============================================================================
// SERVICE PAGE DATA - All 19 service pages content
// ============================================================================
...
const servicePageData = {
  ...
  'emergency-dentistry': {
    ...
    cta: {
      ...
      description: 'Dont suffer through dental pain. Contact us immediately for prompt, professional emergency dental care.',
  ...
  'dental-exams-cleanings': {
    ...
    whatToExpect: {
      ...
      subtitle: '',
      backgroundColor: 'white',
      image: '/assets/service2/cleaning.png',
      items: [
  ...
  'family-dentistry': {
    ...
    hero: {
      ...
      secondaryButtonText: 'Learn More',
      secondaryButtonColor: '#5FC1D7',
      heroImage: '/assets/service3/hero.png',
    ...
    benefits: {
      ...
      items: [
        ...
        { icon: 'Shield', iconColor: '#10b981', title: 'Complete Records', description: 'All your familys dental histories in one place for coordinated, comprehensive care', order: 3 },
    ...
    ageGroups: {
      ...
      subtitle: 'Specialized attention for each stage of your familys dental development',
      backgroundColor: 'white',
      groups: [
  ...
  'kids-dentistry': {
    ...
    hero: {
      ...
      secondaryButtonText: 'Learn More',
      secondaryButtonColor: '#5FC1D7',
      heroImage: '/assets/service4/hero.png',
    ...
    features: {
      ...
      backgroundColor: 'white',
      image: '/assets/service4/office.png',
  ...
  'tooth-extractions': {
    ...
    hero: {
      ...
      secondaryButtonText: 'Learn More',
      secondaryButtonColor: '#5FC1D7',
      heroImage: '/assets/service5/placeholder1.png',
    ...
    process: {
      ...
      backgroundColor: 'white',
      image: '/assets/service5/placeholder2.png',
    ...
    whatToExpect: {
      ...
      items: [
        ...
        { title: 'After the Procedure', borderColor: '#27A8E0', items: ['Mild to moderate soreness for 3-7 days', 'Swelling peaks at 24-48 hours', 'Avoid strenuous activity for several days', 'Follow post-op instructions carefully'], order: 2 }
      ]
    },
    tips: {
      enabled: true,
      ...
      backgroundColor: 'white',
      sections: [
        { title: 'First 24 Hours', borderColor: '#5FC1D7', items: ['Rest and apply ice', 'Bite on gauze', 'Keep head elevated', 'Avoid rinsing and spitting forcefully'], order: 1 },
        { title: 'Diet & Nutrition', borderColor: '#27A8E0', items: ['Soft, cool foods', 'Avoid hot, hard, crunchy, or spicy foods for several days'], order: 2 },
        { title: 'Pain Management', borderColor: '#10b981', items: ['Take prescribed or recommended pain medication as directed', 'Apply warm compresses after 48 hours'], order: 3 },
        { title: 'Activity Restrictions', borderColor: '#f59e0b', items: ['No smoking', 'No drinking through straws', 'No strenuous exercise for at least one week'], order: 4 }
      ]
    },
    types: {
      enabled: true,
      title: 'Tooth Replacement Options',
      subtitle: 'We can help restore your
